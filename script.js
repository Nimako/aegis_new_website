...
if (reviewPreview) reviewPreview.innerHTML = '<img class="review-screen-image" src="assets/team-review-screen.png" alt="Aegis review queue showing four governed actions and queue health" /><div class="review-row-focus" role="img" aria-label="Update beneficiary details, needs approval, Review"><span class="review-focus-index">01</span><div><small>REVIEW QUEUE</small><b>Update beneficiary details</b><em>Prepared for your team · 2m ago</em></div><span class="review-focus-status">Needs approval</span><strong>Review</strong></div>';
