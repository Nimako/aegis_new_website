...
if (reviewPreview) reviewPreview.innerHTML = '<div class="review-panel-head"><small>REVIEW QUEUE · 1 ACTION</small><strong>Review</strong></div><div class="review-row-focus" role="group" aria-label="Update beneficiary details, needs approval, Review"><span class="review-focus-avatar avatar-photo avatar-maya" role="img" aria-label="Maya Chen"></span><div class="review-focus-copy"><small>ONE ACTION NEEDS YOUR REVIEW</small><b>Update beneficiary details</b><em>Prepared by Aegis assist · 2m ago</em></div><span class="review-focus-status">Policy check passed</span></div>';
