...
const views = {
  ...
  approvals: `<div class="view-two"><div class="queue-list"><h4>Review queue <span class="badge yellow">6 pending</span></h4>${['Update beneficiary details', 'Issue replacement card', 'Escalate KYC exception', 'Adjust payment limit'].map((item, index) => `<div class="queue-item"><span>${['AM', 'JS', 'KD', 'TL'][index]}</span><div><b>${item}</b><small>Prepared by Assistant assist · ${index + 2}m ago</small></div><span class="badge">Review</span></div>`).join('')}</div><div class="queue-list"><h4>Queue health</h4><div class="view-stat"><small>AVG. TIME TO REVIEW</small><b>4m 12s</b><em>↓ 32%</em></div><div class="view-stat" style="margin-top:9px"><small>APPROVED TODAY</small><b>42</b><em>98% within policy</em></div></div></div>`,
